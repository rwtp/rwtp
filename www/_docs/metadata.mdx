...
### Offer metadata should be encrypted

Before publishing a user's shipping address and other offer information, you should encrypt it. To ensure a the other party can decrypt it, all offers have the form:
