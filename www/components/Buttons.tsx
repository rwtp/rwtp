...
export function WalletConnectedButton(props: {
   ...
   return <>
      <ConnectButton.Custom>
         {({
            ...
            const childrenWithWallet = React.Children.map(props.children, child =>
               React.cloneElement(child as React.ReactElement<any>, { account: account.address })
            );
...
export function KeyStoreConnectedButton(props: {
   children: React.ReactNode;
}) {
